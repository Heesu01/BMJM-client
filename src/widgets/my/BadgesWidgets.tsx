      ...
      <div className="mt-[24px] grid place-items-center">
        ...
        >
          ...
          <img
            src={badge.imageUrl}
            alt={badge.name}
            className="relative h-[171px] w-[170px] object-contain"
          />
        </div>

        <div className="text-bold14 bg-sub text-main mt-[10px] h-[31px] w-[184px] rounded-full text-center leading-[31px]">
          {badge.name}
        </div>
      </div>
    </div>
      ...
      {badges.map((b) => (
        <li key={b.id} className="relative">
          <div
            ...
            aria-label={b.name}
          >
            <div className="grid h-16 w-16 place-items-center transition-transform active:scale-95">
              <img
                src={b.imageUrl}
                alt={b.name}
